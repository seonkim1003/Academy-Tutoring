...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  email_already_linked_to_other_google_account:
    ...
    <div className="flex-1 bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-sm w-full bg-white rounded-xl border border-gray-200 p-8 text-center">
        ...
        <p className="text-sm text-gray-500 mb-6">
          Sign in with your Google account to request a tutor or sign up to tutor.
        </p>
        {errorMsg && (
        ...
        <a
          href={href}
          className="inline-flex items-center justify-center gap-3 w-full rounded-md border border-gray-300 bg-white py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition"
        >
          <GoogleIcon />
          Sign in with Google
        </a>
