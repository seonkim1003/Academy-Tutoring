...
export function MatchAccept() {
    ...
    if (state === "success") {
        return (_jsx("div", { className: "min-h-screen bg-gray-50 flex items-center justify-center px-4", children: _jsxs("div", { className: "max-w-sm w-full text-center", children: [_jsx("div", { className: "w-14 h-14 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4", children: _jsx("svg", { className: "w-7 h-7 text-green-600", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }) }), _jsx("h1", { className: "text-xl font-bold text-gray-900 mb-2", children: "Match accepted!" }), _jsx("p", { className: "text-gray-500 text-sm", children: "Thanks for confirming. The student has been emailed your contact information, and you should receive an email with theirs shortly." })] }) }));
    }
