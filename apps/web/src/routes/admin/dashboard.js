...
export function AdminDashboard() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gray-50", children: [_jsx(AdminTopBar, {}), _jsxs("div", { className: "max-w-5xl mx-auto px-4 py-8", children: [_jsx("h1", { className: "text-xl font-bold text-gray-900 mb-6", children: "Overview" }), _jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10", children: [_jsx(StatCard, { label: "Pending requests", value: data?.pendingRequests ?? 0 }), _jsx(StatCard, { label: "Active tutors", value: data?.activeTutors ?? 0 }), _jsx(StatCard, { label: "Total matches", value: data?.totalMatches ?? 0 }), _jsx(StatCard, { label: "Accepted matches", value: data?.acceptedMatches ?? 0, sub: data?.totalMatches
