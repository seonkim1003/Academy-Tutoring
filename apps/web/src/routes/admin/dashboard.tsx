      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4 text-sm text-gray-600">
            <Link to="/admin/requests" className="hover:text-gray-900">Requests</Link>
            <Link to="/admin/tutors" className="hover:text-gray-900">Tutors</Link>
            <Link to="/admin/matches" className="hover:text-gray-900">Matches</Link>
            <Button
              variant="ghost"
              size="sm"
              onClick={() =>
                api.post("/admin/logout", {}).then(() => (window.location.href = "/admin/login"))
              }
            >
              Log out
            </Button>
